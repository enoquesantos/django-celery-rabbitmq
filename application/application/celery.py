...
from .utils import get_env, notify_slack
...
class BaseTaskWithRetry(Task):
    ...
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        ...
        notify_slack(msg, "backend-errors")
...
app = Celery(
    ...
    include=[
        'apps.post.celerytasks',
        'apps.notification.celerytasks',
    ]
)
...
app.conf.timezone = get_env('TIME_ZONE')
